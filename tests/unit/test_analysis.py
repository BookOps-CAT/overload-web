...
class TestReviewer:
    ...
    def test_attach_acq(self, order_level_bib, sierra_response):
        ...
        attached_bibs = service.analyze_matches([acq_response])
    ...
    def test_attach_cat_bpl(self, full_bib, sierra_response):
        ...
        attached_bibs = service.analyze_matches([cat_response])
    ...
    def test_attach_sel(self, order_level_bib, sierra_response):
        ...
        attached_bibs = service.analyze_matches([sel_response])
        assert attached_bibs[0].target_bib_id == "12345"
