...
class BibMatcher:
    ...
    def _match_bib(
        self, record: matching.DomainBib, matchpoints: dict[str, str]
    ) -> list[dict[str, Any]]:
        """
    ...
    def match_full_record(self, record: matching.DomainBib) -> list[dict[str, Any]]:
        """
    ...
    def review_matches(
        self, bib: matching.DomainBib, matches: list[dict[str, Any]]
