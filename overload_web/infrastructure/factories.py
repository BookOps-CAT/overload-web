...
def get_matcher_for_library(
    library: str, matchpoints: list
) -> bib_matcher.BibMatchService:
    ...
    return bib_matcher.BibMatchService(fetcher=fetcher, matchpoints=matchpoints)
