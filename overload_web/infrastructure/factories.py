from overload_web.domain.logic import bibs
from overload_web.infrastructure.bibs import marc_adapters, sierra


def get_matcher_for_library(library: str, matchpoints: list) -> bibs.BibMatcher:
    ...
    return bibs.BibMatcher(fetcher=fetcher, matchpoints=matchpoints)
